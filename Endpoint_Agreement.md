...
> **Dự án:** EShop — Software Testing (T06 API & Contract Testing)  
> **Base URL:** `http://localhost:3000`  
> **Người lập:** Nam (Contract Testing & Documentation)  
> **Người review/chốt:** Toàn (API Testing — Postman & Newman)  
> **Ngày tạo:** 2026-07-11  
> **Trạng thái:** ⏳ Chờ Toàn review & chốt

---

## Mục đích

Tài liệu này đảm bảo **Contract Test (Pact — Nam)** và **API Test (Postman — Toàn)** hoàn toàn đồng bộ trên cùng một bộ kịch bản test. Mỗi test case đều được mapping 1:1 giữa hai tool, tránh tình trạng:
- Postman test một scenario mà Pact không cover (hoặc ngược lại).
- Provider State trong Pact không khớp với dữ liệu test trong Postman.
- Schema/Response structure bị lệch giữa hai bên.
...
| Hạng mục | Toàn (Postman) | Nam (Pact) |
|---|---|---|
| Viết request & assertion cho mỗi test case | ✅ **Responsible** | — |
| Định nghĩa Provider State cho mỗi test case | — | ✅ **Responsible** |
| Định nghĩa Pact Matchers (schema matching) | — | ✅ **Responsible** |
| Xác nhận schema/response structure khớp | ✅ **Accountable** | ✅ **Accountable** |
| Ghi nhận bugs vào report | ✅ **Consulted** | ✅ **Responsible** |
| Review & chốt bảng endpoint này | ✅ **Approve** | ✅ **Inform** |
