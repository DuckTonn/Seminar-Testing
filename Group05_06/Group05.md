...
- **Ghi chú lại các "failure mode" của Postman** :
  ...
  - *Silent Failure trong Test script:* Viết sai syntax JavaScript ở tab Tests có thể khiến test không chạy hết các lệnh phía dưới nhưng Postman không báo lỗi cú pháp rõ ràng ra UI (chỉ bị skip ngầm).
